...
(function(){
  ...
  var MANUAL=[
   ...
   {c:'work',t:'Records — the filing system',g:'records files filing cabinet documents source of truth sot store where do files go plans contracts insurance',
    b:'The Records room is the firm\'s filing system and single source of truth. Eight cabinets — Projects, Clients & contracts, Agencies & permits, Sealed & issued, Money, People & licenses, Standards, The firm. Anything marked Source of truth is the version that governs; working copies sit beside it clearly marked, so nobody guesses which copy is current. Drop a file into a cabinet to file it.'},
